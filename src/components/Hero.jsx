      ...
      <div className="container mx-auto h-full">
        <div className="relative z-20 h-full w-full xl:max-w-[768px] flex flex-col items-center xl:items-start justify-center text-center xl:text-left pt-10">
          <h1 className="h1 mb-2 max-w-[320px] xl:max-w-none">
            <span className="text-slate-400">I Build And</span> Design powerful
            <TypeAnimation
              sequence={['webSite', 2000, 'App', 2000]}
              speed={50}
              repeat={Infinity}
              wrapper="span"
              cursor={false}
          ...
          <p className="lead max-w-[476px] mb-7">
            Delivering powerful, custom webSite that blend aesthetics with performance.
          </p>
        ...
        <div className="hidden xl:flex w-[55%] h-[700px] absolute top-0 right-0 bg-slate-200">
          <div className="absolute w-[503px] h-[638px] -bottom-6 z-40 left-[18%]">
            <Image
              alt="Shumayl"
          ...
          <div className="absolute top-[500px] left-[3%]" data-scroll data-scroll-speed='0.2'>
            <RotatingShape
              content={<Image src='assets/hero/shape-1.svg' width={38} height={38} alt="" className="filter-red" />}
              direction='left'
              duration={6}
            />
          </div>
          <div className="absolute top-[100px] xl:left-[30%]" data-scroll data-scroll-speed='0.2'>
            <RotatingShape
          ...
          <div className="absolute top-[300px] xl:left-[80%]" data-scroll data-scroll-speed='0.08'>
            <RotatingShape
